...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: "unikey" }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: "true", description: "banned or no" }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.BOOLEAN, defaultValue: false }),
    __metadata("design:type", Boolean)
], User.prototype, "banned", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: "for what banned", description: "desscription banned" }),
